...
namespace JuegoConsola
{
    ...
    class Enemigo
    {
        ...
        private DateTime _tiempoMovimiento { get; set; }
        ...
        public Enemigo(Point Posicion, ConsoleColor Color, Ventana VentanaC,
            TipoEnemigo TipoEnemigo,Nave NaveC)
        {
        ...
        public void Mover()
        {
            ...
            int tiempo = 30;     //cambiar luego a 30
        ...
        public void Colisiones(Point posicionAux)
        {
            ...
            //}
            //if (posicionAux.Y + 2 >= VentanaC.LimiteSuperior.Y )
            //{
            //    _direccion = Direccion.Arriba;
            //    posicionAux.Y = VentanaC.LimiteSuperior.Y + 13;

            //}

            if (posicionAux.X <= VentanaC.LimiteSuperior.X + 1)
                _direccion = Direccion.Derecha;
            if (posicionAux.X + ancho >= VentanaC.LimiteInferior.X - 1)
                _direccion = Direccion.Izquierda;  
            if (posicionAux.Y <= VentanaC.LimiteSuperior.Y + 1)
                _direccion = Direccion.Abajo;            
        ...
        public void DireccionAleatoria()
        {
            ...
            if (DateTime.Now > _tiempoDireccion.AddMilliseconds(200)
